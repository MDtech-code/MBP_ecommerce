...
//
// Changes:
//   - AlertBanner adopted for formError
//   - Dark mode added to all cards, selects, read-only fields
//   - Dead provincePreview return value noted — AddressForm
//     does not display province (backend derives it) so it
//     is correctly absent from JSX. provincePreview removed
//     from destructuring to make this explicit.
