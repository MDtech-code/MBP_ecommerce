...
export default function CartTrust() {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 bg-white rounded-xl border border-gray-200 mt-8 divide-y lg:divide-y-0 lg:divide-x divide-gray-200">
