...
//
// Changes: dark mode added to all cards, text, borders, buttons
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-[#0a0a0a] rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-6">
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
          ...
          <div className="relative shrink-0">
            <div className="w-24 h-24 rounded-2xl bg-gray-100 dark:bg-gray-800 overflow-hidden border border-gray-200 dark:border-gray-700 flex items-center justify-center">
              {user?.profile?.avatar ? (
                <img
                ...
                <UserRound size={48} className="text-gray-300 dark:text-gray-600" />
              )}
            </div>
            <button
          ...
          <div className="flex-1 text-center sm:text-left">
            ...
            <div className="flex items-center justify-center sm:justify-start gap-2 mt-3">
              ...
              {user?.is_verified && (
                <span className="bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400 text-xs font-bold px-3 py-1 rounded-full">
                  Verified
                </span>
              )}
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {/* Personal */}
        <div className="bg-white dark:bg-[#0a0a0a] rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-6">
          <h3 className="font-black text-gray-900 dark:text-gray-100 text-sm uppercase tracking-wide mb-4">
        ...
        <div className="bg-white dark:bg-[#0a0a0a] rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-black text-gray-900 dark:text-gray-100 text-sm uppercase tracking-wide">
              Default Address
            </h3>
            <button
          ...
          {defaultAddress ? (
            ...
            <div className="flex flex-col items-center justify-center py-6 gap-2">
              <MapPin size={24} className="text-gray-200 dark:text-gray-700" />
      ...
      {defaultAddress?.full_address && (
        <div className="bg-white dark:bg-[#0a0a0a] rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-5 flex items-center gap-3">
