...
export default function DashboardLayout() {
  return (
    <div className="flex flex-col lg:flex-row flex-1 min-h-[calc(100vh-4rem)] bg-surface dark:bg-[#070707] transition-colors">
      
      {/* ── DASHBOARD SIDEBAR ── */}
      {/* Renders Horizontal Pill Rail on Mobile/Tablet, Vertical Sidebar on Desktop */}
      <DashboardSidebar />
