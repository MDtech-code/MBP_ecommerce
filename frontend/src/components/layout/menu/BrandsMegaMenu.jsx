...
import { useBrands, useCategoriesTree } from "../../../hooks/products/useProductQueries";
...
export default function BrandsMegaMenu({ onClose }) {
  ...
  if (isLoading) {
    return (
      <div className="absolute top-full left-1/2 -translate-x-1/2 w-[960px]
  ...
  return (
    <div
      className="absolute top-full left-1/2 -translate-x-1/2 w-[960px]
                 bg-white border border-gray-200 shadow-2xl rounded-b-xl
                 z-50 flex flex-col"
