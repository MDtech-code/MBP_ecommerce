...
#     # FIX — null means not applicable
#     is_read = models.BooleanField(
#         _("is read"),
#         null=True,
#         blank=True,
#         default=None,
#         help_text=_("Only set for IN_APP channel. Null for SMS/Email/WhatsApp."),
#     )
#     failure_reason = models.TextField(_("failure reason"), blank=True, default="")
